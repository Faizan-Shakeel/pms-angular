...
app.controller('CreateProjectModalInstanceController', ['$scope', '$uibModal', '$uibModalInstance', 'dataForThisModalInstance', 'ProjectService', 'TaskService', 'DocumentService', 'UserService', '$localStorage', function ($scope, $uibModal, $uibModalInstance, dataForThisModalInstance, ProjectService, TaskService, DocumentService, UserService, $localStorage) {
...
// Datepicker
    ...
    vm.createOrUpdateProject = function(project_params)
    {
        ...
        var new_project_params = {
            ...
            'modifiedDate': '',
            'endDate': '',
            'createdBy': $localStorage.currentUser.users.name,
            'lastModifiedBy': '',
            'numberOfTasks': '',
            'numberOfDocuments': '',
            'numberOfUsers': '',
...
app.controller('CreateTaskModalController', ['$scope', '$uibModal', '$uibModalInstance', 'dataForThisModalInstance', 'ProjectService', 'TaskService', 'DocumentService', 'UserService', '$localStorage', function ($scope, $uibModal, $uibModalInstance, dataForThisModalInstance, ProjectService, TaskService, DocumentService, UserService, $localStorage) {
...
// Datepicker
    ...
    vm.createOrUpdateTask = function(task_params) {
        ...
        mongoCrudService.updateData(taskToEdit.id , {'tasks': taskToEdit});
        if(dataForThisModalInstance.isGlobal)
        {
            if(documentDeletedFlag)
            {
...
app.controller('CreateDocumentModalInstanceController', ['$scope', '$uibModalInstance', 'dataForThisModalInstance', 'ProjectService', 'DocumentService','Upload', '$rootScope', function ($scope, $uibModalInstance, dataForThisModalInstance, ProjectService, DocumentService, Upload, $rootScope) {
    ...
    $rootScope.fileUploadStatusProgress = {};
...
app.controller('UserProfileModalInstanceController', ['$scope', '$uibModal', '$uibModalInstance', 'dataForThisModalInstance', 'ProjectService', 'UserService', 'NotificationsAndHistoryService', '$localStorage', function ($scope, $uibModal, $uibModalInstance, dataForThisModalInstance, ProjectService, UserService, NotificationsAndHistoryService, $localStorage) {
