...
app.service('chatService', function()
{
    ...
    {
        userMessagesObject.push({username: message.username, receiverEmail: message.receiverEmail, content: message.content});
    ...
    //   contains the complete chat messages. The function uses selectedUserObject
    ...
    var selectChat = function(selectedUserObject, userMessagesObject, senderEmail)
    {
        ...
        {            
            if ((selectedUserObject.email == userMessagesObject[i].username && senderEmail == userMessagesObject[i].receiverEmail ) || (selectedUserObject.email == userMessagesObject[i].receiverEmail && senderEmail == userMessagesObject[i].username))
            {
